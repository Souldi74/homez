...
puts "Приветвсую тебя #{name}, Ответь на вопросы"
...
for items in questions do
    puts items

    user_inputs = nil

    while user_inputs != "yes" and user_inputs != "no"
        puts "Введите yes или no и нажмите Enter"
        user_inputs = STDIN.gets.chomp.downcase
    end
...
puts "\n Ваш результат ответов - да #{yes_answers}"
